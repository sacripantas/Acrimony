...
public class TrueRicmodDeathHandler : MonoBehaviour
{
	[Header("True")]
	...
	public static TrueRicmodDeathHandler instance = null;
	...
	{
		TrueRicmodAI.instance.CancelAll();
		yield return null;
	}
